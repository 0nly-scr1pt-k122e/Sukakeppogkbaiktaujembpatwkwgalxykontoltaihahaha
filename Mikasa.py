...
def mulai_spam(nomor):
    ...
    "1": spam_otp_sidemang,
    "2": spam_otp_adiraku,
    "3": spam_otp_tokopedia,
    "4": spam_otp_singa_kedua,
    "5": spam_otp_singa,
    "6": spam_otp_singa_wa,
    "7": spam_otp_pinhome,
    "8": spam_otp_duniagames,
    "9": spam_otp_acc,
    "10": spam_otp_acc_kedua,
    "11": spam_otp_absenku,
    "12": spam_otp_saturdays,
    "13": spam_otp_maulagi,
    "14": spam_otp_bliblitiket,
    "15": spam_otp_matahari,
    "16": spam_otp_rumah123,
    "17": spam_otp_halodoc,
    "18": spam_otp_misteraladin,
    "19": spam_otp_paper,
    "20": spam_otp_planetban,
    "21": spam_otp_bunda,
    "22": spam_otp_bonusbelanja,
    "23": spam_otp_hijup,
    "24": spam_otp_alodokter_sms,
    "25": spam_otp_alodokter,
    "26": spam_otp_optikmelawai,
    "27": spam_otp_jembatani,
    "28": spam_otp_datascripmall,
    "29": spam_otp_rcx,
    "30": spam_otp_sahabatteknisi,
    "31": spam_otp_liva,
    "32": spam_otp_daihatsu,
    "33": spam_otp_singa_toy,
    "34": spam_otp_kreditpintar,
    "35": spam_otp_internetrakyat,
    "36": spam_otp_pinjamduit,
    "37": spam_otp_isellershop,
    "38": spam_otp_greensm,
    "39": spam_otp_tiptip,
    "40": spam_otp_dokterin,
    "41": spam_otp_uangme,
    "42": spam_otp_seva,
    "43": spam_otp_uatas,
    "44": spam_otp_topindowa,
    "45": spam_otp_amaha,
    "46": spam_otp_kasirpintar,
    "47": spam_otp_bigseller,
    "48": spam_otp_toyota,
    "49": spam_otp_carro,
    "50": spam_otp_idealz,
    "51": spam_otp_ktakilat,
    "52": spam_otp_bantusaku,
    "53": spam_otp_bisatopup,
    "54": spam_otp_speedcash,
    "55": spam_otp_speedcash_wa,
    "56": spam_otp_speedcash_sms,
    "57": spam_otp_sicepat,
    "58": spam_otp_iskconmumbai,
    "59": spam_otp_jogjakita,
    "60": spam_otp_yogyaonline,
    "61": spam_otp_mengantar,
    "62": spam_otp_volta,
    "63": spam_otp_pluang,
    "64": spam_otp_watsons,
    "65": spam_otp_watsons_kedua,
    "66": spam_otp_youtap,
    "67": spam_otp_beautyhaul,
    "68": spam_otp_byu,
    "69": spam_otp_astradaihatsu2,
    "70": spam_otp_astradaihatsu_sms,
    "71": spam_otp_myvalue,
    "72": spam_otp_vedantu,
    "73": spam_otp_viuum,
    "74": spam_otp_onebunda,
    "75": spam_otp_ibudanbalita,
    "76": spam_otp_joob,
    "77": spam_otp_rivafashion,
    "78": spam_otp_swiggy,
    "79": spam_otp_cilory,
    "80": spam_otp_naturalfarm,
    "81": spam_otp_gritero,
    "82": spam_otp_toss,
    "83": spam_otp_topindosms,
    "84": spam_otp_toss2,
    "85": spam_otp_eiger,
    "86": spam_otp_farmaklik,
    "87": spam_otp_nutriclub,
    "88": spam_otp_eci_signup,
    "89": spam_otp_eci,
    "90": spam_otp_qoalaplus,
    "91": spam_otp_singa_yoi,
    "92": spam_otp_uangme,
    "93": telp_spam_jogjakita,
    "94": spam_otp_fastwork,
    "95": spam_otp_sms_optikmelawai,
    "96": spam_otp_mapclub_wa,
    "97": spam_otp_mapclub_wa_kedua,
    "98": spam_otp_mapclub_sms,
    "99": spam_otp_mapclub_sms_kedua,
    "100": spam_otp_ruparupa,
    "101": spam_otp_cashenable,
    "102": spam_eraspace,
    "103": spam_otp_jec,
    "104": spam_otp_oyorooms,
    "105": spam_otp_kitabisa_wea,
    "106": spam_otp_auto2000,
    "107": spam_otp_buccheri,
    "108": spam_otp_generasimaju,
    "109": spam_otp_norkaroots,
    "110": spam_otp_kpoin,
    "111": spam_otp_99co,
    "112": spam_otp_bunda_cms,
    "113": spam_otp_pkumayong,
    "114": spam_otp_babyhappy,
    "115": spam_otp_els,
    "116": spam_otp_dreamdubai,
    "117": spam_otp_bukuaku,
    "118": spam_otp_starlite,
    "119": spam_otp_unpatti,
    "120": spam_otp_ykkipeduli,
}
     hasil = {}
     total_api = len(apis)
...
def tool_cctv():
    pantau_aktivitas()
    import os, sys, time, json, requests, threading, re, subprocess
    from datetime import datetime
    ...
    ⠀⠀⠀⠀⠉⠻⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀
    """
    os.system(f'echo "{ascii_cctv}" | lolcat 2>/dev/null || echo "{ascii_cctv}"')
    
    print(f"""
{W}╭─────────────────────────────────────────────────────────────────╮
{W}│ {W}Tools {R}: {G}CCTV Scraper 193 Negara {R}│ {W}Developer {R}: {G}Rullzzz06
{W}╰─────────────────────────────────────────────────────────────────╯""")
    ...
    # ============ TAMPILKAN MENU ============
    print(f"{W}╭─────────────────────────────────────────────────────────────────╮")
    print(f"{W}│ {W}Pilih {G}Negara{W} untuk Scrape CCTV Public")
    print(f"{W}├─────────────────────────────────────────────────────────────────┤")
    
    # Tampilkan negara 4 kolom
    negara_list = list(NEGARA.items())
    for i in range(0, len(negara_list), 4):
        row = ""
        for j in range(4):
            if i+j < len(negara_list):
                kode, nama = negara_list[i+j]
                row += f"{W}│ {G}{kode}{W} {nama:<18}"
        print(row)
    
    print(f"{W}├─────────────────────────────────────────────────────────────────┤")
    print(f"{W}│ {W}[ {R}0{W} ] Kembali")
    print(f"{W}╰─────────────────────────────────────────────────────────────────╯{N}")
    
    pilih = input(f"{U}❯❯❯ {W}Masukkan Kode Negara {G}❯{N} ").strip().upper()
    
    if pilih == "0":
        return
    
    if pilih not in NEGARA:
        print(f"{W}[ {R}??{W} ] Kode {pilih} tidak valid!{N}")
        input(f"{U}❯❯❯ {W}Tekan Enter untuk kembali...{N}")
        return
    
    def load_bar(stop_event, text="Scraping CCTV", length=15):
        COLORS = ['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m']
        RESET = '\x1b[0m'
        color_index = 0
        while not stop_event.is_set():
    ...
    def scrape_cctv(kode):
        """Scrape CCTV dari insecam.org"""
        nama = NEGARA.get(kode, "Unknown")
        ...
        try:
            ...
            cams = re.findall(r"http://\d{1,3}(?:\.\d{1,3}){3}:\d+/?", resp.text)
            cams = list(set(cams))
            ...
            return {"kode": kode, "negara": nama, "total": 0, "error": str(e)}
    
    print()
    stop_loading = threading.Event()
    loading_thread = threading.Thread(target=load_bar, args=(stop_loading, f"Scraping {NEGARA[pilih]} ({pilih})..."))
    loading_thread.daemon = True
    loading_thread.start()
    
    results = scrape_cctv(pilih)
    ...
    if results['total'] > 0:
        print(f"""
{W}╭─────────────────────────────────────────────────────────────────╮
{W}│ {G}✓{W} Hasil Scrape CCTV {results['negara']} ({results['kode']}){N}
{W}├─────────────────────────────────────────────────────────────────┤
{W}│ {W}Total CCTV {R}: {G}{results['total']}{N}
{W}├─────────────────────────────────────────────────────────────────┤""")
        
        for i, cam in enumerate(results['cams'], 1):
            print(f"{W}│ {G}{i:>2}. {cam}{N}")
        
        print(f"{W}├─────────────────────────────────────────────────────────────────┤")
        print(f"{W}│ {W}Pilih CCTV yang mau dibuka (1-{results['total']})")
        print(f"{W}│ {W}[ {R}0{W} ] Kembali")
        print(f"{W}╰─────────────────────────────────────────────────────────────────╯{N}")
        
        while True:
            pilih_cctv = input(f"{U}❯❯❯ {W}Pilih CCTV {G}❯{N} ").strip()
            
            if pilih_cctv == "0":
                break
            
            try:
                idx = int(pilih_cctv) - 1
                if 0 <= idx < results['total']:
                    cam = results['cams'][idx]
                    print(f"\n{W}[ {Y}!!{W} ] Membuka CCTV: {cam}{N}")
                    os.system(f'xdg-open "{cam}" 2>/dev/null &')
                    print(f"{W}[ {G}✓{W} ] CCTV dibuka di browser!{N}")
                    
                    lagi = input(f"\n{W}Buka CCTV lain? ({G}y{U}/{R}n{W}){R}: {N}").lower()
                    if lagi != 'y':
                        break
                else:
                    print(f"{W}[ {R}??{W} ] Nomor tidak valid!{N}")
            except ValueError:
                print(f"{W}[ {R}??{W} ] Masukkan angka!{N}")
    else:
        print(f"""
{W}╭─────────────────────────────────────────────────────────────────╮
{W}│ {R}✗{W} Tidak ada CCTV ditemukan untuk {results['negara']} ({results['kode']}){N}
{W}├─────────────────────────────────────────────────────────────────┤
{W}│ {W}Error {R}: {G}{results.get('error', 'Tidak ada CCTV public')}{N}
{W}╰─────────────────────────────────────────────────────────────────╯{N}""")
